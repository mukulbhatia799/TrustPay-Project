...
function Navigation() {
  ...
  return (
    <div className='navigation'>
        ...
        <button onClick={() => {
            navigate('/signin');
        }} className='sign-in'onMouseEnter={handleHoverEnter} onMouseLeave={handleHoverLeave}>Sign In <img id="userIcon" src="https://pwebassets.paytm.com/commonwebassets/paytmweb/header/images/loginImg.svg" alt="User icon" /></button>
    </div>
  )
}
